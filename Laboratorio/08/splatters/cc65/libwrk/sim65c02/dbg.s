...
L037B:	lda     (sp)
	...
	sta     _StackAddr
	bra     L0375
L037F:	jsr     _StackHome
	bra     L0375
L0382:	dec     _StackAddr
	bra     L0375
L0385:	inc     _StackAddr
	bra     L0375
L04ED:	ldx     #$00
	lda     (sp),y
	jmp     incsp2
L0375:	jsr     _UpdateStack
	bra     L036E
...
L03B8:	lda     (sp)
	...
	sta     _CStackAddr+1
	bra     L03B2
L03BC:	jsr     _CStackHome
	bra     L03B2
L03BF:	lda     _CStackAddr
	sec
	sbc     #$02
	sta     _CStackAddr
	bcs     L03B2
...
L04F1:	lda     L0473
	...
	beq     L0485
	bra     L04F2
L047C:	jsr     _UpdateAsm
	bra     L04F2
L047F:	jsr     _UpdateStack
	bra     L04F2
L0482:	jsr     _UpdateCStack
	bra     L04F2
L0485:	jsr     _UpdateDump
L04F2:	lda     L0473
	ina
	and     #$03
	sta     L0473
...
L053C:	lda     (sp),y
	...
	jsr     _ActivateFrame
	jmp     L053E
L04B8:	jsr     _HelpHandler
	bra     L053E
L04BB:	jsr     _SetRTSBreak
	lda     #$01
	sta     (sp)
	bra     L053E
L04C0:	lda     _brk_pc
