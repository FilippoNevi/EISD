...
L0372:	dey
	...
	sta     _StackAddr
	jmp     L036C
L0376:	jsr     _StackHome
	jmp     L036C
L0379:	dec     _StackAddr
	jmp     L036C
L037C:	inc     _StackAddr
	jmp     L036C
L04DE:	ldx     #$00
	lda     (sp),y
	jmp     incsp2
L036C:	jsr     _UpdateStack
	jmp     L0365
...
L03AE:	dey
	...
	sta     _CStackAddr+1
	jmp     L03A8
L03B2:	jsr     _CStackHome
	jmp     L03A8
L03B5:	lda     _CStackAddr
	sec
	sbc     #$02
	sta     _CStackAddr
	bcs     L03A8
...
L04E2:	lda     L0465
	...
	beq     L0477
	jmp     L04E3
L046E:	jsr     _UpdateAsm
	jmp     L04E3
L0471:	jsr     _UpdateStack
	jmp     L04E3
L0474:	jsr     _UpdateCStack
	jmp     L04E3
L0477:	jsr     _UpdateDump
L04E3:	lda     L0465
	clc
	adc     #$01
	and     #$03
...
; ---------------------------------------------------------------
; void __near__ DrawFrame (register __near__ const struct $anon-struct-0016 *, unsigned char)
; ---------------------------------------------------------------
...
L0520:	lda     (sp),y
	...
	jsr     _ActivateFrame
	jmp     L049A
L04A9:	jsr     _HelpHandler
	jmp     L049A
L04AC:	jsr     _SetRTSBreak
	lda     #$01
	ldy     #$00
	sta     (sp),y
	jmp     L0522
