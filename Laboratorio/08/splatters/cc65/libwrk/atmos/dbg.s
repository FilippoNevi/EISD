...
L0501:	lda     L047A
	...
	beq     L048C
	jmp     L0502
L0483:	jsr     _UpdateAsm
	jmp     L0502
L0486:	jsr     _UpdateStack
	jmp     L0502
L0489:	jsr     _UpdateCStack
	jmp     L0502
L048C:	jsr     _UpdateDump
L0502:	lda     L047A
	clc
	adc     #$01
	and     #$03
...
L0542:	lda     (sp),y
	...
	jsr     _ActivateFrame
	jmp     L04AF
L04BE:	jsr     _HelpHandler
	jmp     L04AF
L04C3:	jsr     _SetRTSBreak
	lda     #$01
	ldy     #$00
	sta     (sp),y
	jmp     L0544
