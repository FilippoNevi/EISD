...
set sdx_kernel_name "add"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "E:/University/EISD/06_sources/2_hls_and_SoC/ip/scalar_add/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {add_AXILiteS_s_axi
add
}
set kernel_xo ""
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 a W 0x0 "Data signal of a" {{0 32 a W 0 "Bit 31 to 0 Data signal of a"}}} {0x18 b W 0x0 "Data signal of b" {{0 32 b W 0 "Bit 31 to 0 Data signal of b"}}} {0x20 c R 0x0 "Data signal of c" {{0 32 c R 0 "Bit 31 to 0 Data signal of c"}}} {0x24 c_ctrl R 0x0 "Control signal of c" {{0 1 c_ap_vld R 0 "Control signal c_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 1 latency 0 II x}
