...
L03AD:	dey
	...
	sta     _CStackAddr+1
	jmp     L03A7
L03B1:	jsr     _CStackHome
	jmp     L03A7
L03B4:	lda     _CStackAddr
	sec
	sbc     #$02
	sta     _CStackAddr
	bcs     L03A7
...
L04E1:	lda     L0464
	...
	beq     L0476
	jmp     L04E2
L046D:	jsr     _UpdateAsm
	jmp     L04E2
L0470:	jsr     _UpdateStack
	jmp     L04E2
L0473:	jsr     _UpdateCStack
	jmp     L04E2
L0476:	jsr     _UpdateDump
L04E2:	lda     L0464
	clc
	adc     #$01
	and     #$03
...
L0520:	lda     (sp),y
	...
	jsr     _ActivateFrame
	jmp     L0499
L04A8:	jsr     _HelpHandler
	jmp     L0499
L04AB:	jsr     _SetRTSBreak
	lda     #$01
	ldy     #$00
	sta     (sp),y
	jmp     L0522
