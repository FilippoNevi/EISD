...
.segment	"CODE"
	...
	beq     L0042
	jmp     L00BF
L0040:	jsr     _cbm_k_basin
L0042:	jsr     _cbm_k_readst
	tax
	beq     L0040
	lda     #$02
	jmp     L00C5
...
L0073:	lda     regbank+4
	...
	bne     L0073
	jmp     L00A5
L007B:	jsr     _cbm_k_readst
	tax
	beq     L0081
	lda     #$05
	jmp     L00C5
L0081:	jsr     _cbm_k_basin
	ldy     #$03
	sta     (sp),y
	cmp     #$20
	beq     L007B
...
L0091:	jsr     _cbm_k_basin
	...
	jmp     L00C3
L00C1:	lda     #$01
L00C3:	sta     (regbank+4),y
	jmp     L00A5
L00A3:	jsr     _cbm_k_readst
	tax
	beq     L00A7
	lda     #$06
	jmp     L00C5
L00A7:	jsr     _cbm_k_basin
	ldy     #$03
	sta     (sp),y
L00A5:	ldy     #$03
L00C4:	lda     (sp),y
