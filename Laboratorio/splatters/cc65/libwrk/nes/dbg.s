...
L0377:	dey
	...
	sta     _StackAddr
	jmp     L0371
L037B:	jsr     _StackHome
	jmp     L0371
L037E:	dec     _StackAddr
	jmp     L0371
L0383:	inc     _StackAddr
	jmp     L0371
L04EF:	ldx     #$00
	lda     (sp),y
	jmp     incsp2
L0371:	jsr     _UpdateStack
	jmp     L036A
...
L03B7:	dey
	...
	sta     _CStackAddr+1
	jmp     L03B1
L03BB:	jsr     _CStackHome
	jmp     L03B1
L03BE:	lda     _CStackAddr
	sec
	sbc     #$02
	sta     _CStackAddr
	bcs     L03B1
...
L04F4:	lda     L0476
	...
	beq     L0488
	jmp     L04F5
L047F:	jsr     _UpdateAsm
	jmp     L04F5
L0482:	jsr     _UpdateStack
	jmp     L04F5
L0485:	jsr     _UpdateCStack
	jmp     L04F5
L0488:	jsr     _UpdateDump
L04F5:	lda     L0476
	clc
	adc     #$01
	and     #$03
...
; ---------------------------------------------------------------
; void __near__ DrawFrame (register __near__ const struct $anon-struct-000F *, unsigned char)
; ---------------------------------------------------------------
...
L0533:	lda     (sp),y
	...
	jsr     _ActivateFrame
	jmp     L04AB
L04BA:	jsr     _HelpHandler
	jmp     L04AB
L04BD:	jsr     _SetRTSBreak
	lda     #$01
	ldy     #$00
	sta     (sp),y
	jmp     L0535
