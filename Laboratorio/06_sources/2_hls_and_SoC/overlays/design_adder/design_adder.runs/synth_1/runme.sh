...
HD_PWD='E:/University/EISD/06_sources/2_hls_and_SoC/overlays/design_adder/design_adder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_adder_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_adder_wrapper.tcl
