...
HD_PWD='E:/University/EISD/06_sources/2_hls_and_SoC/overlays/design_adder/design_adder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_adder_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_adder_wrapper.tcl -notrace
